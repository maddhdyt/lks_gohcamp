...
if (isset($_POST['btnUpdate'])) {
    ...
    if ($namafile ==  "") {
        mysqli_query($conn, "UPDATE setting SET bg_banner = '$bgBanner', source_banner = '$bannerSource', head_desc = '$headDesc', profil_desc = '$profilDesc', profil_video = '$profilVideo', gmaps = '$gmaps', address = '$address', contact = '$contact', email = '$email', med_facebook = '$medFacebook', med_instagram = '$medInstagram', med_tiktok = '$medTiktok', med_youtube = '$medYoutube' WHERE id_setting = $id");

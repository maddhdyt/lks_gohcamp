...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Montserrat:wght@400;500;600;700;900&family=Poppins&display=swap"
        rel="stylesheet">
...
<body>
    <div class="wrapper">
        <header class="page-header">
            <img class="bg-banner" src="../assets/img/12-1-Agrowisata-Kampung-Nangorak-By-www.nangorakcamp.com_.jpg"
                alt="">
            <nav class="navbar">
                <div class="container">
                    <div class="logo">
